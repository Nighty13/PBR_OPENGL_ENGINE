...
int main()
{
	...
	glm::vec3 lightColors[] = {
		glm::vec3(1100.0f, 000.0f, 000.0f),
		glm::vec3(000.0f, 800.0f, 000.0f),
		glm::vec3(100.0f, 000.0f, 900.0f),
		glm::vec3(000.0f, 800.0f, 700.0f)
	};
	int nrRows = 7;
	int nrColumns = 7;
	float spacing = 2.5;
	...
	float *data = stbi_loadf(("resources/textures/hdr/HDR_029_Sky_Cloudy_Ref.hdr"), &width, &height, &nrComponents, 0);
...
void ImGui_ImplGlfw_KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	...
	std::cout << io.KeyRepeatDelay << std::endl;
...
//-----------------------------------------------------------------------------
// update camera according to inputs WSAD :P
//-----------------------------------------------------------------------------
static void updateCamera(float deltaT)
{

	static float cameraSpeed = 4.5 * deltaTime;
...
static void RenderUI()
{
	...
	// (show_demo_window)
	ImGui::ShowDemoWindow(&showOverLay);
	...
	if (ImGui::Begin("-",&showOverLay, (corner != -1 ? ImGuiWindowFlags_NoMove : 0) | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoFocusOnAppearing | ImGuiWindowFlags_NoNav))
	{
